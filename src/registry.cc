...
namespace superfastmatch{
  Registry::Registry(const string& filename){
    ...
    documentDB->open("data/document.kcf");
    ...
    hashesDB->open("data/hashes.kcf");
    associationDB = new kc::PolyDB();
    associationDB->open("data/association.kct#bnum=100000");
    miscDB = new kc::PolyDB();
    miscDB->open("data/misc.kch");
