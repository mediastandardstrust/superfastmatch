...
curl http://fallabs.com/kyotocabinet/pkg/kyotocabinet-1.2.72.tar.gz -o external/kyotocabinet-1.2.70.tar.gz
curl http://fallabs.com/kyototycoon/pkg/kyototycoon-0.9.52.tar.gz -o external/kyototycoon-0.9.51.tar.gz
